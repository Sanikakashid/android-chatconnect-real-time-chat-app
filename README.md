...
1. *Clone the repository:*
    bash
    git clone https://github.com/Sanikakashid/android-chatconnect-real-time-chat-app
    cd Chatoon/app
...
For questions or support, please contact [kashidsanika167@gmail.com](mailto:kashidsanika167@gmail.com).
